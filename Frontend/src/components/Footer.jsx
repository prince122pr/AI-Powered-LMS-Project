...
const Footer = () => {
        ...
        <div className="w-full flex justify-between px-10 flex-wrap gap-6">
          <div className="">
            ...
            <div className="flex space-x-4 mt-6 items-center">
              <a href="https://www.linkedin.com/in/prince-web-developer" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition-colors">
  ...
  <path d="M8.3 12.5h4.7v14.5H8.3V12.5zm2.3-7.4a2.7 2.7 0 1 1 0 5.4 2.7 2.7 0 0 1 0-5.4zm7.8 7.4h4.5v2h.1c.6-1.1 2-2.3 4.1-2.3 4.4 0 5.2 2.9 5.2 6.7v7.1h-4.7v-6.3c0-1.5 0-3.5-2.1-3.5-2.1 0-2.4 1.6-2.4 3.3v6.5h-4.7V12.5z" fill="#0077B5"/>
              ...
              <a href="https://www.instagram.com/prince__122__/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition-colors">
