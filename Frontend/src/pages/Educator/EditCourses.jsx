    ...
    const fetchCourse = async () => {
      try {
        ...
        const response = await axios.get(
          `${backendBaseURL}/course/course/${courseId}`,
          {
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl shadow-2xl max-w-md w-full text-center">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 py-3 rounded-xl bg-gray-700 text-white hover:bg-gray-600 transition-all"
              >
                Back to Dashboard
              </button>
              <button
                onClick={() => window.location.reload()}
                className="flex-1 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-red-600 text-white hover:shadow-lg transition-all"
              >
                Try Again
              </button>
            </div>
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex w-full justify-between items-center cursor-pointer">
              ...
              <button
                type="button"
                onClick={() => navigate(`/courses/${courseId}/create-lecture`)}
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium shadow-lg hover:shadow-blue-500/30 transition-all transform hover:-translate-y-1 hover:scale-105 flex items-center gap-2"
              >
                <FaGraduationCap /> Manage Lectures
              </button>
            </div>

          </div>
          <p className="text-white/70 ml-10">
            Update your course information below. Fields marked with * are
            required.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-700/50 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="5"
                  className="w-full px-4 py-3 rounded-lg bg-gray-700/50 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all resize-none"
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 rounded-lg bg-gray-700/50 border border-gray-600 text-white focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
                  required
                >
