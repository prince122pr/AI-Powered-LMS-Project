...
const MainRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/courses/:courseId/create-lecture" element={user?.role === "educator" ? <CreateLectures /> : <Navigate to="/login" replace />} />
      <Route path="/courses/:courseId/edit-lecture/:lectureId" element={user?.role === "educator" ? <EditLectures /> : <Navigate to="/login" replace />} />
